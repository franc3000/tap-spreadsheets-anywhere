...
def sample_file(table_spec, target_filename, sample_rate, max_records):
    LOGGER.info("Sampling {} ({} records, every {}th record).".format(target_filename, max_records, sample_rate))
...
def sample_files(table_spec, target_files, sample_rate=10, max_records=1000, max_files=5):
    to_return = []
